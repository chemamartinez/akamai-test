...
def _build_comparison_data(
    ...
    return {
        ...
        "resources": {
            ...
            "cel_max_memory_alloc_mb": c("monitoring", "resources", "max_memory_alloc_mb"),
            "akamai_max_memory_alloc_mb": a("monitoring", "resources", "max_memory_alloc_mb"),
...
def _build_report_md(
    ...
    lines += [
        ...
        f"|--------|-----|--------|---|--------|",
        f"| Avg memory alloc | {_fmt(r.get('cel_avg_memory_alloc_mb'))} MB | {_fmt(r.get('akamai_avg_memory_alloc_mb'))} MB | {_pct_diff(r.get('cel_avg_memory_alloc_mb'), r.get('akamai_avg_memory_alloc_mb'))} | {_winner(r.get('cel_avg_memory_alloc_mb'), r.get('akamai_avg_memory_alloc_mb'))} |",
        f"| Max memory alloc | {_fmt(r.get('cel_max_memory_alloc_mb'))} MB | {_fmt(r.get('akamai_max_memory_alloc_mb'))} MB | {_pct_diff(r.get('cel_max_memory_alloc_mb'), r.get('akamai_max_memory_alloc_mb'))} | {_winner(r.get('cel_max_memory_alloc_mb'), r.get('akamai_max_memory_alloc_mb'))} |",
